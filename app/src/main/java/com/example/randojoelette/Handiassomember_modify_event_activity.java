    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        Intent intent = new Intent(Handiassomember_modify_event_activity.this, HandiassomemberMainActivity.class);
        ...
        btnNon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Handiassomember_modify_event_activity.this, handiassomember_valid_event_activity.class);
